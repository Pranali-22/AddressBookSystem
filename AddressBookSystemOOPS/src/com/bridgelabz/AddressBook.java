...
public class AddressBook {	
	...
	public static void main(String[] args) {
		...
		System.out.println("\nEnter first name, last name, address, city, state, zip, phone number, email ID sequentially");
		firstName1 = input.nextLine();
	    lastName1 = input.nextLine();
		address1 = input.nextLine();
		city1 = input.nextLine();
		...
		AddressBook addressBookObj2 = new AddressBook(firstName1, lastName1, address1, city1, state1, zip1,
				 phoneNo1, email1);
		
		addressBookObj1.displaData();
		System.out.println();
		addressBookObj2.displaData();
